...
It also provide some cutting, expolratory methods, such as Hierarchical partial correlations. These are are partial correlations based on **linear mixed models** that include the factors as random effects. They can be see as (partial) correlations *adjusted* for some hierarchical (or multilevel) variability.
