...
# Initialize plot
p_base <- ggplot(data, aes(x=V1, y=V2)) +
  see::theme_modern() +
...
# rez plot
fig1 <- p_scatter +
  geom_segment(data=rez, aes(xend = V1, yend = -Inf, colour=Method), size=1, key_glyph = "point") +
...
ggsave("figure1.png", fig1, height = 8, width = see::golden_ratio(8), dpi = 300)
