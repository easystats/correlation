...
\
`results`` ``<-`` `[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``iris``)`\
`results`\
...
\
[`summary`](https://rdrr.io/r/base/summary.html)`(``results``, redundant ``=`` ``TRUE``)`\
`## # Correlation Matrix (pearson-method)`\
`## `\
...
\
`results`` ``%>%`\
`  `[`summary`](https://rdrr.io/r/base/summary.html)`(``redundant ``=`` ``TRUE``)`` ``%>%`\
...
\
[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``iris``, bayesian ``=`` ``TRUE``)`\
`## # Correlation Matrix (pearson-method)`\
`## `\
...
\
[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``iris``, include_factors ``=`` ``TRUE``, method ``=`` ``"auto"``)`\
...
\
`iris`` ``%>%`\
`  `[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``partial ``=`` ``TRUE``)`` ``%>%`\
...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`see`](https://easystats.github.io/see/)`)`` ``# for plotting`\
[`library`](https://rdrr.io/r/base/library.html)`(`[`ggraph`](https://ggraph.data-imaginist.com)`)`` ``# needs to be loaded`\
\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(`[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``mtcars``, partial ``=`` ``TRUE``)``)`` ``+`\
`  `[`scale_edge_color_continuous`](https://ggraph.data-imaginist.com/reference/scale_edge_colour.html)`(``low ``=`` ``"#000004FF"``, high ``=`` ``"#FCFDBFFF"``)`
...
\
`iris`` ``%>%`\
`  `[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``partial ``=`` ``TRUE``, multilevel ``=`` ``TRUE``)`` ``%>%`\
`  `[`summary`](https://rdrr.io/r/base/summary.html)`(``)`\
`## # Correlation Matrix (pearson-method)`\
`## `\
`## Parameter    | Petal.Width | Petal.Length | Sepal.Width`\
...
\
`iris`` ``%>%`\
`  `[`correlation`](https://easystats.github.io/correlation/reference/correlation.md)`(``partial ``=`` ``FALSE``, multilevel ``=`` ``TRUE``)`` ``%>%`\
`  `[`summary`](https://rdrr.io/r/base/summary.html)`(``)`\
`## Parameter    | Petal.Width | Petal.Length | Sepal.Width`\
`## -------------------------------------------------------`\
