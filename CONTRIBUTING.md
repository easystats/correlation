...
Enough with the impostor syndrom! All suggestions and opinions are good,
and even if it’s just a thought or so, it’s always good to receive
feedback.
...
- Before you start to code, make sure you’re on the `dev` branch (the
  ...
  and then, the dev branch will merge into `main`, as a new package
  version.
