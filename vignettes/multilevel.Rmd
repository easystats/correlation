...
and Algorithms for Correlation Analysis in R. _Journal of Open > Source
Software_, _5_(51), 2306. 10.21105/joss.02306
...
**100 trials**. For each of the 1000 total trials, we measured two things,
**V1** and **V2**, and our research aims at **investigating the link between
these two variables**.
...
Indeed, there is **strong, negative and significant correlation** between V1 and
V2. Great, can we go ahead and **publish these results in PNAS**?

## The Simpson's Paradox

Hold on sunshine! Ever heard of something called the [**Simpson's
